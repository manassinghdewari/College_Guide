...
const Filters=()=>
{
  ...
  const checkList1 = ["Enginnering", "Management", "Science", "Arts","Commerece","Computer Applications","Education"];
  const checkList2 = ["Full Time", "Part Time"];
  const checkList3 = ["Goverment", "Private"];
  const checkList4 = ["0-25K", "25-50K", "50-75K", "75K-1L","1-2L","Above 2L"];
